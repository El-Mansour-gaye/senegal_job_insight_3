...
export const MapChart: React.FC<MapChartProps> = ({ data, title }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-premium border border-slate-100 h-[500px] flex flex-col">
        ...
        >
          ...
          {data.map((city, idx) => (
            ...
            >
              <Popup>
                <div className="p-1">
                   <h5 className="font-bold text-slate-800 m-0">{city.city}</h5>
